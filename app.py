...
app = Flask(
    __name__,
    template_folder=r"C:\Users\DELL\OneDrive\Documents\NareshTechSelfRunCodes\18MayHousingRegressorProject\templates"
)

import os
os.chdir(r"C:\Users\DELL\OneDrive\Documents\NareshTechSelfRunCodes\18MayHousingRegressorProject")

# Load models
model_names = [
    'LinearRegression', 'RobustRegression', 'RidgeRegression', 'LassoRegression', 'ElasticNet', 
    'PolynomialRegression','SGDRegressor', 'ANN', 'RandomForest', 'SVM', 'LGBM' , 'KNN'
]
